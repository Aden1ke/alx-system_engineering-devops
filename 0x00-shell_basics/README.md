My first script-i am to print the absolute path name of the current working directory.
My second script-i am to display the contents list of my current directory.
